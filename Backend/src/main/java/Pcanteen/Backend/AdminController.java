...
public class AdminController {
    ...
    @PostMapping("/promote")
    public ResponseEntity<String> promoteToAdmin(@RequestParam String employeeId) {
    ...
    @PostMapping("/demote")
    public ResponseEntity<String> demoteAdmin(@RequestParam String employeeId) {
        Employee employee = employeeRepository.findByEmployeeId(employeeId)
                .orElseThrow(() -> new CustomException("Employee not found"));
...
import Pcanteen.Backend.dto.EmployeeResponseDTO;
import Pcanteen.Backend.exception.CustomException;
import java.util.List;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.ResponseEntity;
...
public class AdminController {
    ...
    @PostMapping("/demote")
    @PreAuthorize("hasRole('SUPER_ADMIN')")
    public ResponseEntity<String> demoteAdmin(@RequestBody PromoteRequest request) {  
        Employee employee = employeeRepository.findByEmployeeId(request.getEmployeeId())
                .orElseThrow(() -> new CustomException("Employee not found"));
...
//@RequestParam boolean active
        ...
        @PreAuthorize("hasRole('ADMIN') or hasRole('SUPER_ADMIN')")
        public ResponseEntity<Employee> updateCustomerStatus(@PathVariable Long id, @RequestParam("isActive") boolean isActive) {
            Employee employee = employeeRepository.findById(id)
                    .orElseThrow(() -> new CustomException("Customer not found"));
