    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">Serving fresh, delicious meals every day</p>
        </div>
      </section>
              ...
              >
                {topItems.map((item) => (
                  <div key={item.id} className="w-full flex-shrink-0">
                    <div className="grid md:grid-cols-2 gap-8 items-center bg-gradient-to-r from-slate-50 to-blue-50 p-8 rounded-xl">
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-slate-800 mb-4">{"Today's Menu - " + getCurrentDay()}</h3>
                ...
                <div className="flex justify-center space-x-2 mt-6">
                  {Array.from({ length: Math.ceil(todayMenu.length / 2) }, (_, index) => (
                    <button
                      key={index}
                      className={`w-3 h-3 rounded-full transition-colors duration-300 ${
                        index === todayMenuSlide ? "bg-blue-600" : "bg-slate-300"
                      }`}
